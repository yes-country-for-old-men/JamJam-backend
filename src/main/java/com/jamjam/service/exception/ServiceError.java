...
public enum ServiceError implements ErrorCode {
    ...
    GEMINI_API_ERROR(HttpStatus.BAD_GATEWAY, "Gemini API 요청 중 오류가 발생했습니다.", "GEMINI_API_ERROR"),
    ...
    PROVIDER_NOT_FOUND(HttpStatus.NOT_FOUND, "해당 제공자를 찾을 수 없습니다.", "PROVIDER_NOT_FOUND"),
    SERVICE_NOT_FOUND(HttpStatus.NOT_FOUND, "해당 서비스를 찾을 수 없습니다.", "SERVICE_NOT_FOUND"),
    S3_IMAGE_NOT_FOUND(HttpStatus.NOT_FOUND, "해당 이미지를 S3에서 찾을 수 없습니다.", "S3_IMAGE_NOT_FOUND"),
    ...
    ServiceError(HttpStatus httpStatus, String message, String errorCode) {
