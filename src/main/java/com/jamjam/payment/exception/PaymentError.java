...
public enum PaymentError implements ErrorCode {
    ...
    ORDER_NOT_FOUND(HttpStatus.BAD_REQUEST, "Merchant ID에 해당하는 주문을 찾을 수 없습니다.", "ORDER_NOT_FOUND"),
    SERVICE_NOT_FOUND(HttpStatus.BAD_REQUEST, "Service ID에 해당하는 서비스를 찾을 수 없습니다.", "SERVICE_NOT_FOUND"),
